...
public class FjxJHipsterFileWatcher implements FileSystemWatcher, Runnable {

	    private static Logger log = LoggerFactory.getLogger(FjxJHipsterFileWatcher.class);
	    ...
	    public FjxJHipsterFileWatcher(List<String> watchFolders, ConfigurableApplicationContext ctx, ClassLoader classLoader) throws Exception {
	    ...
	    public static void register(ClassLoader classLoader, ConfigurableApplicationContext ctx) {
	        try {
	            ...
	            final Thread thread = new Thread(new FjxJHipsterFileWatcher(watchFolders, ctx, classLoader));
	            thread.setDaemon(true);
	            thread.start();

	            Runtime.getRuntime().addShutdownHook(new Thread() {
	                public void run() {
	                	FjxJHipsterFileWatcher.isStarted = false;
	                    try {
	                        thread.join();
