...
class SearchApi(val defBasePath: String = "http://localhost/",
  ...
  def searchUsers (query: String) : Option[List[User]] = {
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, None, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "array", classOf[User]).asInstanceOf[List[User]])
